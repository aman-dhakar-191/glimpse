...
internal object ReactionActionBinder {
    ...
    //
    // The request code includes messageId (not just appWidgetId) so a new
    // message's React button doesn't reuse/mutate a stale PendingIntent
    // still bound to a previous message's id via FLAG_UPDATE_CURRENT.
